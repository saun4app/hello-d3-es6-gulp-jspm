...
$__System.registerDynamic('d', ['8', 'a', 'c'], true, function ($__require, exports, module) {
  /*!
  ...
  var define,
      global = this || self,
      GLOBAL = global;
  var base64 = $__require('8');
  var ieee754 = $__require('a');
  var isArray = $__require('c');
...
$__System.registerDynamic('f', ['e'], true, function ($__require, exports, module) {
  var define,
      ...
      GLOBAL = global;
  /* */
  module.exports = $__System._nodeRequire ? $__System._nodeRequire('buffer') : $__require('e');
  return module.exports;
});
...
$__System.registerDynamic('15', ['10', '14'], true, function ($__require, exports, module) {
  /* */
  "format cjs";
  ...
  })($__require('10').Buffer, $__require('14'));
  return module.exports;
});
...
$__System.register('17', ['5', '6', '16'], function (_export) {
    var _createClass, _classCallCheck, d3, D3TextList;
